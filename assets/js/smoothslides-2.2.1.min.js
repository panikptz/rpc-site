		...
		smoothSlides: function(options) {
			...
			that.zoomOut = function() {
				...
				$(this).find('.ss-slide:eq(-2)').css({
					'transition':'none',
					'transform':'scale('+options.effectModifier+') rotate(1.5deg) translateY(-10%)'
				});
				setTimeout(function(){
					// Wait for fade, then sort & animate next
					$(that).find('.ss-slide:last').prependTo($(".ss-slide-stage", that)).css({
					...
					$(that).find('.ss-slide:last').css({
						'transition': 'all ' + options.effectDuration + 'ms ' + options.effectEasing +'',
						'transform':'scale(1)  rotate(0deg) translateY(-40%)'
					});
				}, options.transitionDuration);
			}
			...
			that.panRight = function() {
				...
				$(this).find('.ss-slide:eq(-2)').css({
					'transition':'none',
					// 'transform':'scale('+options.effectModifier+') translateX(-'+effectModPercent-30+'%)'
				...
				setTimeout(function(){
					...
					$(that).find('.ss-slide:last').css({
						'transition': 'all ' + options.effectDuration + 'ms ' + options.effectEasing +'',
						// 'transform':'scale('+options.effectModifier+') translateX(0%)'
						'transform':'scale(1.2) translateX(-7%) translateY(-20%)'
					});
				}, options.transitionDuration);
			}
			...
			that.panUp = function() {
				...
				$(this).find('.ss-slide:eq(-2)').css({
					'transition':'none',
					'transform':'scale('+options.effectModifier-7.5+') translateY('+effectModPercent+'%)'
				});
				setTimeout(function(){
					// Wait for fade, then sort & animate next
					$(that).find('.ss-slide:last').prependTo($(".ss-slide-stage", that)).css({
					...
					$(that).find('.ss-slide:last').css({
						'transition': 'all ' + options.effectDuration + 'ms ' + options.effectEasing +'',
						// 'transform':'scale('+options.effectModifier+') translateY(-17%)'
